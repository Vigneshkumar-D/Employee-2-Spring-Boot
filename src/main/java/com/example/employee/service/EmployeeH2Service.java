...
public class EmployeeH2Service implements EmployeeRepository{
    ...
    public Employee addEmployee(Employee employee){
        ...
        Employee addedEmployee = db.queryForObject("select * from employeelist where employeeName= ? and email = ?", new EmployeeRowMapper(), employee.getEmployeeName(), employee.getEmail());
